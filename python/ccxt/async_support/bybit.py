...
class bybit(Exchange):
    ...
    async def load_server_time_difference(self):
        response = await self.v2GetPublicTime()
    ...
    async def fetch_markets(self, params={}):
        if self.options['adjustTime']:
            await self.load_server_time_difference()
        response = await self.v2GetPublicSymbols(params)
    ...
    async def fetch_ticker(self, symbol, params={}):
        ...
        response = await self.v2GetPublicTickers(self.extend(request, params))
        return self.parse_ticker(response['result'][0])

    async def fetch_tickers(self, symbol=None, params={}):
        await self.load_markets()
        response = await self.v2GetPublicTickers()
    ...
    async def fetch_my_trades(self, symbol=None, since=None, limit=None, params={}):
        ...
        if limit is not None:
            request['limit'] = limit
        response = await self.v2GetPrivateExecutionList(self.extend(request, params))
    ...
    async def fetch_order_book(self, symbol, limit=None, params={}):
        ...
        response = await self.v2GetPublicOrderBookL2(self.extend(request, params))
        result = {
            'bids': [],
            'asks': [],
            'timestamp': None,
    ...
    async def fetch_balance(self, params={}):
        await self.load_markets()
        request = {}
        response = await self.wapiGetPositionList(self.extend(request, params))
    ...
    async def fetch_ohlcv(self, symbol, timeframe='1m', since=None, limit=None, params={}):
        ...
        response = await self.v2GetPublicKlineList(self.extend(request, params))
    ...
    async def fetch_open_orders(self, symbol=None, since=None, limit=None, params={}):
        ...
        return await self.fetch_orders(symbol, since, limit, request)
    ...
    async def fetch_orders(self, symbol=None, since=None, limit=None, params={}):
        ...
        response = await self.privateGetOrderList(request)
    ...
    async def cancel_order(self, id, symbol=None, params={}):
        ...
        if 'stop_px' in params:
            response = await self.privatePostStopOrderCancel(self.extend(request, params))
        else:
    ...
    async def fetch_withdrawals(self, code=None, since=None, limit=None, params={}):
        ...
        response = await self.privateGetWalletWithdrawList(reqParams)
        return self.parse_transactions(self.safe_value(response['result'], 'data', []), currency, since, limit)

    async def fetch_fund_records(self, code=None, since=None, limit=None, params={}):
        await self.load_markets()
        request = {}
        if since is not None:
            request['start_date'] = self.ymd(since)
        ...
        if code is not None:
            ...
            request['coin'] = currency
        reqParams = self.extend(request, params)
        response = await self.privateGetWalletFundRecords(reqParams)
