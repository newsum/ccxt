...
class coinflex(Exchange):
    ...
    async def fetch_currencies(self, params={}):
        answer = await self.fetch_currencies_from_cache(params)
    ...
    async def fetch_currencies_from_cache(self, params={}):
        ...
        if (timestamp is None) or ((now - timestamp) > expires):
            currencies = await self.publicGetAssets(params)
    ...
    async def fetch_ticker(self, symbol=None, params={}):
        ...
        response = await self.publicGetTickersBaseCounter(self.extend(request, params))
    ...
    async def fetch_order_book(self, symbol, limit=None, params={}):
        ...
        response = await self.publicGetDepthBaseCounter(self.extend(request, params))
    ...
    async def fetch_open_orders(self, symbol=None, since=None, limit=None, params={}):
        await self.load_markets()
        result = await self.privateGetOrders(params)
    ...
    async def fetch_my_trades(self, symbol=None, since=None, limit=None, params={}):
        ...
        if 'id' in params:
            ...
            response = await self.privateGetTradesTime(self.extend(request, query))
            responseArray = []
