...
class phemex(Exchange):
    ...
    def convert_e_number(self, eNum, scale, precision, roundType):
        return self.decimal_to_precision(eNum * math.pow(10, -scale), roundType, precision, DECIMAL_PLACES, PAD_WITH_ZERO)
    ...
    def parse_order_book(self, orderbook, timestamp=None, bidsKey='bids', asksKey='asks', priceKey=0, amountKey=1, market=None):
        ...
        return {
            'bids': self.sort_by(self.parse_bids_asks(rawBids, priceKey, amountKey, priceScale, pricePrecision), 0, True),
    ...
    async def fetch_order_book(self, symbol, limit=None, params={}):
        ...
        response = await getattr(self, method)({'symbol': marketID})
    ...
    async def fetch_balance(self, params={}):
        ...
        btcResponse = await getattr(self, method)({'currency': 'BTC'})
        usdResponse = await getattr(self, method)({'currency': 'USD'})
    ...
    async def fetch_order(self, id, symbol=None, params={}):
        ...
        response = await getattr(self, method)({'orderID': id, 'symbol': marketID})
    ...
    async def fetch_orders(self, symbol=None, since=None, limit=None, params={}):
        ...
        response = await getattr(self, method)({'symbol': marketID, 'start': since, 'limit': limit})
