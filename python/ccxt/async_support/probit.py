...
class probit(Exchange):
    ...
    async def fetch_markets(self, params={}):
        response = await self.publicGetMarket()
    ...
    async def fetch_currencies(self, params={}):
        response = await self.publicGetCurrency()
    ...
    def parse_ticker(self, ticker, market=None):
        ...
        symbol = self.findSymbol(self.safe_string(ticker, 'market_id'), market)
    ...
    async def fetch_open_orders(self, symbol=None, since=None, limit=None, params={}):
        ...
        resp = await self.privateGetOpenOrder(self.extend(request, params))
        orders = self.safe_value(resp, 'data')
        arr = []
        for i in range(0, len(orders)):
            if since and self.parse8601(orders[i]['time']) < since:
                continue
            symbol = self.findSymbol(self.safe_string(orders[i], 'market_id'))
    ...
    async def fetch_closed_orders(self, symbol=None, since=None, limit=None, params={}):
        ...
        if limit:
            request['limit'] = limit
        resp = await self.privateGetOrderHistory(self.extend(request, params))
        orders = self.safe_value(resp, 'data')
        arr = []
        for i in range(0, len(orders)):
            symbol = self.findSymbol(self.safe_string(orders[i], 'market_id'))
    ...
    async def create_order(self, symbol, type, side, amount, price=None, params={}):
        ...
        resp = await self.privatePostNewOrder(self.extend(req, params))
    ...
    async def cancel_order(self, id, symbol=None, params={}):
        ...
        resp = await self.privatePostCancelOrder(self.extend(request, params))
    ...
    async def parse_deposit_addresses(self, rawAddresses):
        addresses = []
    ...
    async def sign_in(self, params={}):
        ...
        tokenResponse = await self.authPostToken(body)
